...
<head>
    ...
    <title>Propositions Récus</title>
</head>
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <a href="index.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                ...
                <a href="Nouveautés.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    Nouveautés</a>
                <a href="PropositionRecu.php" class="list-group-item list-group-item-action bg-transparent second-text active">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">List Des Proposition / Reclamations Des citoyens</h2>
                </div>
...
<div class="form">
  ...
  <div class="form-panel one">
    <div class="form-header">
      <h1>Propositions Des Citoyens </h1>
    </div>
