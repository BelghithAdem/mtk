    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="Demendesrecu.php" class="list-group-item list-group-item-action bg-transparent second-text active">
                        Demendes Récus</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Listes Des Demendes </h2>
                </div>
...
<div class="form">
  ...
  <div class="form-panel one">
   ...
   echo "<tr><td>$ligne[Destinataire]</td>
   <td>$ligne[NomDestinateur]</td>
   <td>$ligne[Sujet]</td>
